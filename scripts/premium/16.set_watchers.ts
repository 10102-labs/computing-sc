...
const premiumUser = "";
const ownerName = "Dat";
const ownerEmail = "Dat.tran2";
const timePriorActivation = 3600;
const legacyAddress = "0xd1999d5a27378970420779b0722118f20858f198"
async function main() {
    ...
    const txData = contract.methods
        .setWatchers(legacyAddress,  ["Dat"], ["0xd1999d5a27378970420779b0722118f20858f198"], [true])
        .encodeABI();
    console.log(txData);
